...
CRATES_IO_MIN_RECENT_DOWNLOADS = int(os.environ.get("CRATES_IO_MIN_RECENT_DOWNLOADS", "10000"))
        ...
        for member in archive:
            ...
            if basename == "crates.csv":
                crates_by_id = {
                    ...
                    if (crate_id := str(row.get("id") or "").strip()) in candidate_crate_ids
